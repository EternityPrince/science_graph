    ...
    try:
        ...
        if is_path:
            ...
            try:
                ...
                try:
                    # Use spacy.cli.download which internally uses pip.
                    # The environment variables set above allow the installation to proceed
                    # even without a virtual environment.
