# RAG Benchmarking Baselines (B0 - B6)

This document provides a precise, detailed technical specification of the 7 benchmarking baselines (**B0** to **B6**) implemented in the Science Graph RAG pipeline.
...
| Component Name | B0 (Zero-Shot) | B1 (Lexical) | B2 (Dense) | B3 (HyDE) | B4 (Hybrid) | B5 (Static Graph) | B6 (Full Pipeline) |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **`intent_classifier`** | OFF | OFF | OFF | OFF | OFF | OFF | **ON** |
| **`graph_ontology_lookup`** | OFF | OFF | OFF | OFF | OFF | OFF | **ON** |
| **`llm_query_expansion`** | OFF | OFF | OFF | OFF | OFF | OFF | **ON** |
| **`hyde`** | OFF | OFF | OFF | **ON** | OFF | OFF | OFF |
| **`lexical_search`** | OFF | **ON** | OFF | OFF | **ON** | **ON** | **ON** |
| **`dense_search`** | OFF | OFF | **ON** | **ON** | **ON** | **ON** | **ON** |
| **`dynamic_alpha_blending`**| OFF | OFF | OFF | OFF | **ON** | **ON** | **ON** |
| **`rrf`** (Reciprocal Rank Fusion) | OFF | OFF | OFF | OFF | **ON** | **ON** | **ON** |
| **`graph_expansion`** | OFF | OFF | OFF | OFF | OFF | **ON (Static 1-Hop)** | **ON (Adaptive Crawl)** |
| **`reranker`** (Cross-Encoder) | OFF | OFF | OFF | OFF | OFF | OFF | **ON** |
| **`score_blending`** | OFF | OFF | OFF | OFF | OFF | OFF | **ON** |
| **`context_trimming`** | OFF | OFF | OFF | OFF | OFF | **ON** | **ON** |
| **`citation_repair`** | OFF | OFF | OFF | OFF | OFF | **ON** | **ON** |
