...
class TestHybridSearch(unittest.TestCase):
    ...
    def test_hybrid_search_scoring_and_reranking(self, mock_cross_encoder_class):
        ...
        self.rag._reranker = mock_reranker
        
        # 4. Mock embedding
        self.emb_engine.get_embedding.return_value = [0.1] * 384
        
        # 5. Mock build_context
        self.rag.build_context = MagicMock(return_value=("context_text", "context_graph"))
        ...
        self.rag.build_context.assert_called_once()
        ...
        called_args = self.rag.build_context.call_args[0][0]
